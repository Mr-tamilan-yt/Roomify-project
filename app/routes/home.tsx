...
export default function Home() {
 ...
 <p className="subtitle">
   Roomify is an Ai-first design environment that helps you visualize, render, and ship architecturalprojects faster than ever.
 </p>
 ...
 <div id="upload" className="upload-shell">
  ...
  <div className="upload-card">
    <div className="upload-head">
      ...
      <p>Support JPG,PNG, formates up to 10MB</p>
    </div>
    <p>Upload images</p>
  </div>
    ...
    <div className="projects-grid">
      <div className="project-card group">
        ...
        <div className="card-body">
          <div>
            <h3>Project Nilson</h3>
            <div className="meta">
              <Clock size={12} />
              <span>{new Date('02.1.2026').toLocaleDateString()}</span>
              <span>By Nk</span>
            </div>
          </div>
          <div className="arrow">
